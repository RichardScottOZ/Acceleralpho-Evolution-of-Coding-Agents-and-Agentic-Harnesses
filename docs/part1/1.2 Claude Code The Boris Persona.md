...
> **Key idea:** Claude Code's personality is not a chatbot with a terminal wrapper. It is an *systems-inhabiting agent* — one that understands and operates within the full context of your development environment: files, git state, running processes, installed tools. That distinction changes everything about how you work with it.
